...
const Tasks = () => {
  ...
  const tasks = [
    ...
    {
      id:2,
      title: "Learn NextJS for create Dashboard",
      description: "Best for SEO and Routing Pages",
      status: "Pending",
      dueDate: "2025-02-18"
    },
    {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-blue-200 p-8'>
            ...
            tasks.map((task)=> (
              ...
              >
                <div className="flex flex-col">
                  ...
                  <p className='text-gray-600 text-sm mt-2'>Due Date: {task.dueDate}</p>
